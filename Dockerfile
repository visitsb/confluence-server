...
COPY mysql-connector-java-5.1.49-bin.jar .
...
RUN /usr/bin/apt-get update \
 ...
 && /bin/chmod +rw ./mysql-connector-java-5.1.49-bin.jar \
 ...
 && /bin/mv ./mysql-connector-java-5.1.49-bin.jar ${CONFLUENCE_INSTALL_DIR}/confluence/WEB-INF/lib \
